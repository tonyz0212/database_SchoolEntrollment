...
<head>
<meta charset="UTF-8">
<title>Upper Division Form</title>
</head>
<body>
<%
	...
	if (action != null && action.equals("insert")) {
		...
		double gpa = Double.parseDouble(request.getParameter("GPA"));
   		...
   		sm.insertUpper(degreeid,unit,gpa); 
	}
...
%>
	...
	<table>
		...
		<tr>
			<form action="upper.jsp" method="get">
	...
	try {
		...
		ResultSet rset = stmt.executeQuery ("SELECT l.degree, l.require_units, l.gpa FROM upper_division l;");
